...
for (var count = 0; count < catArray.length; count++) {
  console.log(catArray[count].name);
  console.log(catArray[count].colour);
  console.log(catArray[count].age);
}
...
function logToConsole(loggedtoconsole) {
